(function (global, factory) {
	...
	var ownKeys$4 = getBuiltIn$3('Reflect', 'ownKeys') || function ownKeys(it) {
	...
	*/
	...
	$$8({ target: 'Object', stat: true, forced: !NATIVE_SYMBOL, sham: !DESCRIPTORS$3 }, {
	  // `Object.create` method
	  // https://tc39.es/ecma262/#sec-object.create
	  create: $create,
	  // `Object.defineProperty` method
	...
	// `Object.getOwnPropertyDescriptor` method
	// https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
	$$6({ target: 'Object', stat: true, forced: FORCED, sham: !DESCRIPTORS$2 }, {
	...
	*/
	...
	var Checkbox = function Checkbox(props) {
	  ...
	  var nativeRadioProps = function (_ref) {
	    _ref.className;
	        _ref.indeterminate;
	        _ref.children;
	        _ref.error;
	        _ref.tag;
	        var keys = _objectWithoutProperties(_ref, ["className", "indeterminate", "children", "error", "tag"]);

	    return _objectSpread$1({}, keys);
	  }(props);

	  return /*#__PURE__*/React.createElement("label", {
	    className: classNames("ft-checkbox", className)
	  }, /*#__PURE__*/React.createElement("input", _extends({
	    type: "checkbox"
	  }, nativeRadioProps, {
	    className: classNames(indeterminate && !checked && "is-indeterminate")
	  })), tag ? /*#__PURE__*/React.createElement("span", {
	    className: "ft-checkbox-tag"
	  }, children) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
	    className: "ft-checkbox-front"
	  }, tag && children), children && /*#__PURE__*/React.createElement("span", {
	...
	var CheckboxGroup = function CheckboxGroup(props) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: classNames("ft-checkbox-group", className)
	  }, children && children.length > 0 && children.map(function (child, i) {
	    return /*#__PURE__*/React.cloneElement(child, _objectSpread(_objectSpread({}, childProps), {}, {
	      checked: props.value ? props.value.includes(child.props.value) : props.defaultValue ? props.defaultValue.includes(child.props.value) : props.defaultValue,
	      key: child.key !== undefined && child.key || child.props.value !== undefined && child.props.value || i
	    }));
	  }));
	};
