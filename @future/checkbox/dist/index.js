  ...
  */
  ...
  const Checkbox = props => {
    ...
    const nativeRadioProps = (_ref => {
      let keys = _objectWithoutProperties(_ref, ["className", "indeterminate", "children", "error", "tag"]);
  ...
  const CheckboxGroup = props => {
    ...
    }, children && children.length > 0 && children.map((child, i) => /*#__PURE__*/React.cloneElement(child, _objectSpread(_objectSpread({}, childProps), {}, {
