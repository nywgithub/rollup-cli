import React, { createContext, useContext, useImperativeHandle, useEffect, createElement as createElement$2, Children, forwardRef, useRef, useReducer, useCallback, useMemo, useLayoutEffect, Component, Fragment } from 'react';
...
function Formik(props) {
  ...
  return createElement$2(FormikProvider, {
    value: formikbag
  }, component ? createElement$2(component, formikbag) : render ? render(formikbag) : children // children come last, always called
...
var Form$1 = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return createElement$2("form", Object.assign({
...
function connect(Comp) {
  var C = function C(props) {
    return createElement$2(FormikConsumer, null, function (formik) {
      ...
      return createElement$2(Comp, Object.assign({}, props, {
        formik: formik
      }));
    });
  };
...
var FieldArrayInner = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return component ? createElement$2(component, props) : render ? render(props) : children // children come last, always called
...
var ErrorMessageImpl = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return !!touch && !!error ? render ? isFunction(render) ? render(error) : null : children ? isFunction(children) ? children(error) : null : component ? createElement$2(component, rest, error) : error : null;
  };
...
export { Form, FormItem, FutureErrorMessage, FutureField, FieldArray as FutureFieldArray, FutureFormik };
