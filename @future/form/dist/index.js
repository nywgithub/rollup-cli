    ...
    */
    ...
    const FutureErrorMessage = props => {
      return /*#__PURE__*/React.createElement(ErrorMessage, _extends({}, props, {
        children: props.children || (error => /*#__PURE__*/React.createElement("div", {
    ...
    class FutureFormik extends React.Component {
      constructor(props) {
        super(props);
      ...
      render() {
        ...
        const connectedFocusError = scrollToFirstError && /*#__PURE__*/React.createElement(ConnectedFocusError, typeof scrollToFirstError === "object" ? scrollToFirstError : {});
        ...
        }), scrollToFirstError ? typeof children === "function" ? props => /*#__PURE__*/React.createElement(React.Fragment, null, connectedFocusError, children(props)) : /*#__PURE__*/React.createElement(React.Fragment, null, connectedFocusError, children) : children);
      }
