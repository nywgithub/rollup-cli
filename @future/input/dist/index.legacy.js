(function (global, factory) {
	...
	*/
	...
	var Input = /*#__PURE__*/React.forwardRef(function (props, ref) {
	  ...
	  var inputProps = function (_ref) {
	    _ref.error;
	        var keys = _objectWithoutProperties(_ref, ["error"]);
	...
	var TextArea = function TextArea(props) {
	  var className = props.className,
	      ...
	      counter = _props$counter === void 0 ? true : _props$counter,
	      _props$rows = props.rows,
	      rows = _props$rows === void 0 ? 3 : _props$rows;

	  var textAreaProps = function (_ref) {
	    _ref.error;
	        _ref.counter;
	        var rest = _objectWithoutProperties(_ref, ["error", "counter"]);

	    return _objectSpread({}, rest);
	  }(props);

	  var counterMaxLength = props.maxLength || maxLength;
	  ...
	  var textarea = /*#__PURE__*/React.createElement("textarea", _extends({}, textAreaProps, {
