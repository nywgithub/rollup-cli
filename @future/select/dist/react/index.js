...
import { Checkbox } from '@future/checkbox/dist/react';
...
class Select extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "handleSelectClick", e => {
    ...
    this.selectWrapperRef = /*#__PURE__*/createRef();
  }
  ...
  renderOptionList(options, groupDisabled) {
    ...
    return options.length > 0 && /*#__PURE__*/React.createElement("ul", {
      className: "select-list-wrap"
    }, options.map(option => /*#__PURE__*/React.createElement(React.Fragment, {
      key: option.props.value
    }, /*#__PURE__*/React.cloneElement(option, {
      optClassName: classNames(option.props.optClassName, multiple && "multiple-opt"),
      prefix: multiple && /*#__PURE__*/React.createElement(Checkbox, {
  ...
  render() {
    ...
    const selectClassNames = classNames(!bordered && "ft-select-none-border", displayTop && "top", this.props.className);
    classNames("select-selected", (Array.isArray(value) ? value.length <= 0 : !value) && "select-placeholder");
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Picker, {
    ...
    }, listOfOptionsOrGroup.length > 0 && listOfOptionsOrGroup.map((optionsOrGroup, index) => /*#__PURE__*/React.createElement(React.Fragment, {
      key: index
    }, Array.isArray(optionsOrGroup) ? this.renderOptionList(optionsOrGroup) : /*#__PURE__*/React.cloneElement(optionsOrGroup, {
      ...
      defaultValue: value
    }, children.map(child => child.type === OptionGroup ? /*#__PURE__*/React.createElement("optgroup", {
...
class Option extends React.Component {
  ...
  render() {
    ...
    const optClassNames = classNames("select-opt", selected && "selected", disabled && "disabled", optClassName);
