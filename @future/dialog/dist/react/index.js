    ...
    //------------------------------------------------
        ...
        var artDialog = function (config, ok, cancel) {
            ...
            var api,
                ...
                elem = config.follow = this && this.nodeType === 1 && this || config.follow;
        ...
        artDialog.fn = artDialog.prototype = {
            ...
            defaultFocus: function () {
                this._defaultFocus = $('#ft-dlg-default-focus-elem');
        ...
        artDialog._templates = ''
            ...
            +	'<div class="ft-dlg-dialog">'

            +		'<div class="ft-dlg-header">'
            +			'<div class="ft-dlg-titlebar">'
            +				'<div class="ft-dlg-title"></div>'
            +				'<span class="ft-dlg-close">'
            +					'<i class="ft-icon icon-delete"></i>'
            +				'</span>'
            +			'</div>'
            +		'</div>'

            +		'<div class="ft-dlg-icon">'
            +			'<div class="ft-dlg-iconBg"></div>'
            +		'</div>'
            +		'<div class="ft-dlg-main">'
            +			'<div class="ft-dlg-content"></div>'
            +		'</div>'

            +		'<div class="ft-dlg-footer">'
            +			'<div class="ft-dlg-footer-content"></div>'
            +			'<div class="ft-dlg-buttons"></div>'
            +		'</div>'

            +	'</div>'

            +	'<div class="ft-dlg-se"></div>'
            +	'<a href="#" id="ft-dlg-default-focus-elem" style="margin-top:-20px; display:block; width:1px; height:1px; overflow:hidden;">x</a>';
  ...
  return new ArtDialog({
    ...
    init: function init() {
      ...
      if ( /*#__PURE__*/React.isValidElement(content)) {
        ReactDOM.render(content, contentElement, function () {
    ...
    close: function close() {
      ...
      if (userCloseReturn !== false) {
        ...
        /*#__PURE__*/
        React.isValidElement(content) && ReactDOM.unmountComponentAtNode(contentElement);
...
var callNoticeDialog = function callNoticeDialog(content, options) {
  ...
  return callDialog(type ? /*#__PURE__*/React.createElement(DialogNoticeContent, {
    title: title,
    type: type
  }, content) : content, _objectSpread2(_objectSpread2({
...
var callAlertDialog = function callAlertDialog(content, options) {
  return callNoticeDialog(content, _objectSpread2(_objectSpread2({}, options), {}, {
    cancel: undefined,
    close: false
  }));
};

export { callAlertDialog, callConfirmDialog, callDialog, getDialogInstance };
