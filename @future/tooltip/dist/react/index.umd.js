(function (global, factory) {
  ...
  var indexedObject$1 = fails$6$1(function () {
    // throws an error in rhino, see https://github.com/mozilla/rhino/issues/346
    // eslint-disable-next-line no-prototype-builtins -- safe
    return !Object('z').propertyIsEnumerable(0);
  }) ? function (it) {
    return classof$1(it) == 'String' ? split$1.call(it, '') : Object(it);
  } : Object;
  ...
  var toIndexedObject$4$1 = function (it) {
  ...
  var descriptors$1 = !fails$5$1(function () {
  ...
  var global$c$1 = global$d$1;
  var isObject$4$1 = isObject$5$1;

  var document$1$1 = global$c$1.document;
  // typeof document.createElement is 'object' in old IE
  var EXISTS$2 = isObject$4$1(document$1$1) && isObject$4$1(document$1$1.createElement);
  ...
  var ie8DomDefine$1 = !DESCRIPTORS$4$1 && !fails$4$1(function () {
  ...
  var toPrimitive$2 = function (input, PREFERRED_STRING) {
    ...
    var fn, val;
    if (PREFERRED_STRING && typeof (fn = input.toString) == 'function' && !isObject$2$1(val = fn.call(input))) return val;
    if (typeof (fn = input.valueOf) == 'function' && !isObject$2$1(val = fn.call(input))) return val;
    if (!PREFERRED_STRING && typeof (fn = input.toString) == 'function' && !isObject$2$1(val = fn.call(input))) return val;
  ...
  var anObject$4$1 = anObject$5$1;
  var toPrimitive$1$1 = toPrimitive$2;
  ...
  objectDefineProperty$1.f = DESCRIPTORS$3$1 ? $defineProperty$1 : function defineProperty(O, P, Attributes) {
    anObject$4$1(O);
  ...
  var createNonEnumerableProperty$7 = DESCRIPTORS$2$1 ? function (object, key, value) {
    return definePropertyModule$3$1.f(object, key, createPropertyDescriptor$2$1(1, value));
  } : function (object, key, value) {
    object[key] = value;
    return object;
  };

  var global$b$1 = global$d$1;
  var createNonEnumerableProperty$6 = createNonEnumerableProperty$7;

  var setGlobal$3$1 = function (key, value) {
    try {
      createNonEnumerableProperty$6(global$b$1, key, value);
    } catch (error) {
      global$b$1[key] = value;
    } return value;
  };

  var global$a$1 = global$d$1;
  var setGlobal$2$1 = setGlobal$3$1;

  var SHARED$1 = '__core-js_shared__';
  var store$3$1 = global$a$1[SHARED$1] || setGlobal$2$1(SHARED$1, {});
  ...
  var has$9 = Object.hasOwn || function hasOwn(it, key) {
    return hasOwnProperty$1.call(toObject$1$1(it), key);
  };
  ...
  var global$9$1 = global$d$1;

  var path$1 = global$9$1;

  var path = path$1;
  var global$8$1 = global$d$1;
  ...
  var getBuiltIn$3$1 = function (namespace, method) {
    return arguments.length < 2 ? aFunction$1(path[namespace]) || aFunction$1(global$8$1[namespace])
      : path[namespace] && path[namespace][method] || global$8$1[namespace] && global$8$1[namespace][method];
  };
  ...
  var global$7$1 = global$d$1;
  var userAgent$1 = engineUserAgent$1;

  var process$1$1 = global$7$1.process;
  ...
  var nativeSymbol$1 = !!Object.getOwnPropertySymbols && !fails$3$1(function () {
    var symbol = Symbol();
  ...
  var Symbol$1$1 = global$6$1.Symbol;
  var createWellKnownSymbol$1 = USE_SYMBOL_AS_UID$2 ? Symbol$1$1 : Symbol$1$1 && Symbol$1$1.withoutSetter || uid$1$1;

  var wellKnownSymbol$5$1 = function (name) {
    if (!has$8(WellKnownSymbolsStore$1, name) || !(NATIVE_SYMBOL$2 || typeof WellKnownSymbolsStore$1[name] == 'string')) {
      if (NATIVE_SYMBOL$2 && has$8(Symbol$1$1, name)) {
  ...
  var toIndexedObject$3$1 = toIndexedObject$4$1;
  ...
  var createMethod$1 = function (IS_INCLUDES) {
    return function ($this, el, fromIndex) {
      var O = toIndexedObject$3$1($this);
  ...
  var has$7 = has$9;
  var toIndexedObject$2$1 = toIndexedObject$4$1;
  var indexOf$1 = arrayIncludes$1.indexOf;
  var hiddenKeys$3$1 = hiddenKeys$4$1;
  ...
  var objectKeysInternal$1 = function (object, names) {
    ...
    var result = [];
    var key;
    for (key in O) !has$7(hiddenKeys$3$1, key) && has$7(O, key) && result.push(key);
  ...
  var anObject$3$1 = anObject$5$1;
  var objectKeys$2 = objectKeys$1$1;

  // `Object.defineProperties` method
  // https://tc39.es/ecma262/#sec-object.defineproperties
  // eslint-disable-next-line es/no-object-defineproperties -- safe
  var objectDefineProperties$1 = DESCRIPTORS$1$1 ? Object.defineProperties : function defineProperties(O, Properties) {
    anObject$3$1(O);
    var keys = objectKeys$2(Properties);
    var length = keys.length;
    var index = 0;
    var key;
    while (length > index) definePropertyModule$2$1.f(O, key = keys[index++], Properties[key]);
    return O;
  };
  ...
  var anObject$2$1 = anObject$5$1;
  var defineProperties$1 = objectDefineProperties$1;
  var enumBugKeys$1$1 = enumBugKeys$3$1;
  var hiddenKeys$2$1 = hiddenKeys$4$1;
  var html$2 = html$1$1;
  var documentCreateElement$3 = documentCreateElement$1$1;
  ...
  var NullProtoObject$1 = function () {
    ...
    while (length--) delete NullProtoObject$1[PROTOTYPE$1][enumBugKeys$1$1[length]];
  ...
  var objectCreate$1 = Object.create || function create(O, Properties) {
    var result;
    if (O !== null) {
      EmptyConstructor$1[PROTOTYPE$1] = anObject$2$1(O);
  ...
  var wellKnownSymbol$4$1 = wellKnownSymbol$5$1;
  var create$1$1 = objectCreate$1;
  var definePropertyModule$1$1 = objectDefineProperty$1;

  var UNSCOPABLES$1 = wellKnownSymbol$4$1('unscopables');
  var ArrayPrototype$1 = Array.prototype;

  // Array.prototype[@@unscopables]
  // https://tc39.es/ecma262/#sec-array.prototype-@@unscopables
  if (ArrayPrototype$1[UNSCOPABLES$1] == undefined) {
    definePropertyModule$1$1.f(ArrayPrototype$1, UNSCOPABLES$1, {
      configurable: true,
  ...
  if (typeof store$1$1.inspectSource != 'function') {
  ...
  var global$5$1 = global$d$1;
  var inspectSource$1$1 = inspectSource$2$1;

  var WeakMap$1$1 = global$5$1.WeakMap;
  ...
  var global$4$1 = global$d$1;
  var isObject$1$1 = isObject$5$1;
  var createNonEnumerableProperty$5$1 = createNonEnumerableProperty$7;
  var objectHas = has$9;
  var shared$4 = sharedStore$1;
  var sharedKey$1$1 = sharedKey$3$1;
  var hiddenKeys$1$1 = hiddenKeys$4$1;

  var OBJECT_ALREADY_INITIALIZED$1 = 'Object already initialized';
  var WeakMap$2 = global$4$1.WeakMap;
  ...
  if (NATIVE_WEAK_MAP$1 || shared$4.state) {
    ...
    var STATE$1 = sharedKey$1$1('state');
    hiddenKeys$1$1[STATE$1] = true;
    set$1 = function (it, metadata) {
      if (objectHas(it, STATE$1)) throw new TypeError(OBJECT_ALREADY_INITIALIZED$1);
      metadata.facade = it;
      createNonEnumerableProperty$5$1(it, STATE$1, metadata);
      return metadata;
    };
    get$1 = function (it) {
      return objectHas(it, STATE$1) ? it[STATE$1] : {};
    };
    has$6 = function (it) {
      return objectHas(it, STATE$1);
    };
  }
  ...
  // Nashorn ~ JDK8 bug
  var NASHORN_BUG$1 = getOwnPropertyDescriptor$1$1 && !$propertyIsEnumerable$1.call({ 1: 2 }, 1);
  ...
  var toIndexedObject$1$1 = toIndexedObject$4$1;
  var toPrimitive$3 = toPrimitive$2;
  var has$5 = has$9;
  ...
  objectGetOwnPropertyDescriptor$1.f = DESCRIPTORS$6 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
    O = toIndexedObject$1$1(O);
    P = toPrimitive$3(P, true);
    if (IE8_DOM_DEFINE$2) try {
      return $getOwnPropertyDescriptor$1(O, P);
    } catch (error) { /* empty */ }
    if (has$5(O, P)) return createPropertyDescriptor$1$1(!propertyIsEnumerableModule$1.f.call(O, P), O[P]);
  };

  var redefine$2$1 = {exports: {}};

  var global$3$1 = global$d$1;
  var createNonEnumerableProperty$4$1 = createNonEnumerableProperty$7;
  var has$4 = has$9;
  var setGlobal$1$1 = setGlobal$3$1;
  var inspectSource$3 = inspectSource$2$1;
  var InternalStateModule$1$1 = internalState$1;

  var getInternalState$1$1 = InternalStateModule$1$1.get;
  var enforceInternalState$1 = InternalStateModule$1$1.enforce;
  var TEMPLATE$1 = String(String).split('String');

  (redefine$2$1.exports = function (O, key, value, options) {
    ...
    if (typeof value == 'function') {
      if (typeof key == 'string' && !has$4(value, 'name')) {
        createNonEnumerableProperty$4$1(value, 'name', key);
      }
    ...
    if (simple) O[key] = value;
    else createNonEnumerableProperty$4$1(O, key, value);
  // add fake Function#toString for correct work wrapped methods / constructors with methods like LoDash isNative
  })(Function.prototype, 'toString', function toString() {
    return typeof this == 'function' && getInternalState$1$1(this).source || inspectSource$3(this);
  });
  ...
  var anObject$1$1 = anObject$5$1;

  // all object keys, includes non-enumerable and symbols
  var ownKeys$2$1 = getBuiltIn$5('Reflect', 'ownKeys') || function ownKeys(it) {
    var keys = getOwnPropertyNamesModule$1.f(anObject$1$1(it));
    var getOwnPropertySymbols = getOwnPropertySymbolsModule$1.f;
    return getOwnPropertySymbols ? keys.concat(getOwnPropertySymbols(it)) : keys;
  };

  var has$3 = has$9;
  var ownKeys$1$1 = ownKeys$2$1;
  ...
  var isForced$1$1 = function (feature, detection) {
    ...
    return value == POLYFILL$1 ? true
      ...
      : typeof detection == 'function' ? fails$2$1(detection)
      : !!detection;
  };
  ...
  var global$2$1 = global$d$1;
  var getOwnPropertyDescriptor$2 = objectGetOwnPropertyDescriptor$1.f;
  var createNonEnumerableProperty$3$1 = createNonEnumerableProperty$7;
  var redefine$1$1 = redefine$2$1.exports;
  ...
  */
  var _export$1 = function (options, source) {
    ...
    if (GLOBAL) {
      ...
      target = global$2$1[TARGET] || setGlobal$4(TARGET, {});
    } else {
      target = (global$2$1[TARGET] || {}).prototype;
    }
    if (target) for (key in source) {
      ...
      if (options.sham || (targetProperty && targetProperty.sham)) {
        createNonEnumerableProperty$3$1(sourceProperty, 'sham', true);
      }
      // extend global
      redefine$1$1(target, key, sourceProperty, options);
    }
  };

  var fails$1$1 = fails$7$1;

  var correctPrototypeGetter$1 = !fails$1$1(function () {
    function F() { /* empty */ }
  ...
  var fails$8 = fails$7$1;
  var getPrototypeOf$1$1 = objectGetPrototypeOf$1;
  var createNonEnumerableProperty$2$1 = createNonEnumerableProperty$7;
  var has$1 = has$9;
  var wellKnownSymbol$3$1 = wellKnownSymbol$5$1;

  var ITERATOR$2$1 = wellKnownSymbol$3$1('iterator');
  ...
  var NEW_ITERATOR_PROTOTYPE$1 = IteratorPrototype$2$1 == undefined || fails$8(function () {
    var test = {};
  ...
  if (!has$1(IteratorPrototype$2$1, ITERATOR$2$1)) {
    createNonEnumerableProperty$2$1(IteratorPrototype$2$1, ITERATOR$2$1, returnThis$1);
  }
  ...
  var has$a = has$9;
  var wellKnownSymbol$2$1 = wellKnownSymbol$5$1;

  var TO_STRING_TAG$1$1 = wellKnownSymbol$2$1('toStringTag');

  var setToStringTag$2$1 = function (it, TAG, STATIC) {
    if (it && !has$a(it = STATIC ? it : it.prototype, TO_STRING_TAG$1$1)) {
      defineProperty$2(it, TO_STRING_TAG$1$1, { configurable: true, value: TAG });
    }
  };
  ...
  var setToStringTag$1$1 = setToStringTag$2$1;

  var createIteratorConstructor$1$1 = function (IteratorConstructor, NAME, next) {
    var TO_STRING_TAG = NAME + ' Iterator';
    IteratorConstructor.prototype = create$2(IteratorPrototype$1$1, { next: createPropertyDescriptor$4(1, next) });
    setToStringTag$1$1(IteratorConstructor, TO_STRING_TAG, false);
    return IteratorConstructor;
  };

  var isObject$6 = isObject$5$1;
  ...
  var setToStringTag$3 = setToStringTag$2$1;
  var createNonEnumerableProperty$1$1 = createNonEnumerableProperty$7;
  var redefine$4 = redefine$2$1.exports;
  var wellKnownSymbol$1$1 = wellKnownSymbol$5$1;
  ...
  var defineIterator$1$1 = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
    ...
    if (anyNativeIterator) {
      ...
      if (IteratorPrototype$3 !== Object.prototype && CurrentIteratorPrototype.next) {
        if (getPrototypeOf$2(CurrentIteratorPrototype) !== IteratorPrototype$3) {
          if (setPrototypeOf$1) {
            setPrototypeOf$1(CurrentIteratorPrototype, IteratorPrototype$3);
          } else if (typeof CurrentIteratorPrototype[ITERATOR$1$1] != 'function') {
            createNonEnumerableProperty$1$1(CurrentIteratorPrototype, ITERATOR$1$1, returnThis$2);
          }
        }
    ...
    if (IterablePrototype[ITERATOR$1$1] !== defaultIterator) {
      createNonEnumerableProperty$1$1(IterablePrototype, ITERATOR$1$1, defaultIterator);
    }
    ...
    if (DEFAULT) {
      ...
      } else $$1({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS$2 || INCORRECT_VALUES_NAME }, methods);
    }

    return methods;
  };

  var toIndexedObject$6 = toIndexedObject$4$1;
  ...
  var getInternalState$2 = InternalStateModule$2.getterFor(ARRAY_ITERATOR$1);
  ...
  var global$1$1 = global$d$1;
  var DOMIterables$1 = domIterables$1;
  var ArrayIteratorMethods$1 = es_array_iterator$1;
  var createNonEnumerableProperty$8 = createNonEnumerableProperty$7;
  var wellKnownSymbol$7 = wellKnownSymbol$5$1;
  ...
  for (var COLLECTION_NAME$1 in DOMIterables$1) {
    var Collection = global$1$1[COLLECTION_NAME$1];
    var CollectionPrototype = Collection && Collection.prototype;
    if (CollectionPrototype) {
      // some Chrome versions have non-configurable methods on DOMTokenList
      if (CollectionPrototype[ITERATOR$3] !== ArrayValues$1) try {
        createNonEnumerableProperty$8(CollectionPrototype, ITERATOR$3, ArrayValues$1);
      } catch (error) {
        CollectionPrototype[ITERATOR$3] = ArrayValues$1;
      }
      if (!CollectionPrototype[TO_STRING_TAG$2]) {
        createNonEnumerableProperty$8(CollectionPrototype, TO_STRING_TAG$2, COLLECTION_NAME$1);
      }
      if (DOMIterables$1[COLLECTION_NAME$1]) for (var METHOD_NAME in ArrayIteratorMethods$1) {
        // some Chrome versions have non-configurable methods on DOMTokenList
  ...
  */
  ...
  function preventOverflow(_ref) {
    ...
    if (checkMainAxis || checkAltAxis) {
      ...
      if (checkMainAxis) {
        var preventedOffset = within(tether ? min$3(min$1, tetherMin) : min$1, offset, tether ? max$2(max$1, tetherMax) : max$1);
  ...
  */
  ...
  function validateProps(partialProps, plugins) {
    ...
    keys.forEach(function (prop) {
      ...
      var didPassUnknownProp = !hasOwnProperty$2(nonPluginProps, prop); // Check if the prop exists in `plugins`
  ...
  function createTippy(reference, passedProps) {
    ...
    function handleAriaContentAttribute() {
      ...
      var id = popper.id;
      var nodes = normalizeToArray$1(instance.props.triggerTarget || reference);
    ...
    function onTrigger(event) {
      ...
      if (!instance.state.isVisible && isMouseEvent$1(event)) {
  ...
  const Popover = props => {
    const popoverProps = (_ref => {
      ...
      return _objectSpread$2({
        plugins: [prefixClassNamePlugin, ...plugins]
      }, rest);
    })(props);

    return /*#__PURE__*/React__default['default'].createElement(index, popoverProps);
  };
  ...
  const Tooltip = props => {
    const subset = (_ref => {
      let {
        ...
        theme
          ...
          rest = _objectWithoutProperties$1(_ref, ["className", "theme"]);
    ...
    return /*#__PURE__*/React__default['default'].createElement(Popover, _extends({}, subset, {
    ...
    const subset = (_ref => {
      let {
        ...
        plugins
          ...
          rest = _objectWithoutProperties$1(_ref, ["offset", "plugins"]);
